	...
	$.ajax({
		...
		success: (e) => {
			...
			for(var n = 0; n < e.page.length; n++) {
				...
				var str =
					'<a href="../shoppingcar.html ../shoppingcartwo.html"><div class="goodsImg"><img src=' +
					'"' + img + '"' +
			...
			var names = e.slides[0].name;
			var mans = e.slides[1].man;
			var zhes = e.slides[2].zhe;
			var oldpays = e.slides[3].oldpay;
			var newpays = e.slides[4].newpay;
			var jifens = e.slides[5].jifen;
			var kucuns = e.slides[6].kucun;
			var ss = '<h1 class="classifyHeader">'+ names +'<span>' + mans + '<span class="gapLine">&nbsp</span>' + zhes + '</span>' +'</h1>'+
				'<div class="goodsBuy">' +
